    ...
    <PageLayout>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <div className="relative mb-12">
              ...
              <span className="text-sm font-black text-sky-500 uppercase tracking-[0.4em] mb-4 block relative z-10">About ANK</span>
            ...
            <p className="text-xl md:text-2xl text-slate-300 max-w-2xl font-medium leading-relaxed mb-12">
              We help our clients to seamlessly move programs through design and production with engineering excellence.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative z-20 -mt-16 px-6">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatBox value="30+" label="World awards" sub="Taking seamless key performance indicators." />
            <StatBox value="99%" label="Project success" sub="Engage fully tested process improvement." />
            <StatBox value="60+" label="Expertise" sub="Multidisciplinary team of engineers." />
            <StatBox value="15+" label="Years of Excellence" sub="Driving industrial evolution since day one." />
          </div>
        </div>
      </section>
      ...
      <section className="py-40 relative mt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            <span className="text-sm font-black text-sky-500 uppercase tracking-[0.5em] mb-8 block">Who is ANK?</span>
            <h2 className="text-3xl md:text-5xl font-black tracking-normal mb-12 uppercase leading-[1.2]">
              A multidisciplinary team providing <span className="text-sky-500">cutting edge</span> solution, design, development & manufacturing services
            </h2>
            <Link 
              to="/contact" 
            ...
            >
              Join us on a project <ArrowRight size={20} />
            </Link>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-32 bg-slate-50">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-[10px] font-black text-sky-500 tracking-[0.5em] uppercase mb-4">Our Team</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="relative group overflow-hidden rounded-2xl aspect-[4/5]">
               ...
               <div className="absolute inset-0 bg-sky-600/90 p-8 flex flex-col justify-center text-white">
                  <span className="text-xs font-black uppercase tracking-widest mb-4 opacity-70">Careers</span>
                  <h4 className="text-2xl font-black leading-tight mb-6">Interested in joining ANK?</h4>
                  <p className="text-sm font-medium opacity-80 mb-8 leading-relaxed">Simply fill out the Careers form and we will contact you as soon as possible.</p>
                  <Link to="/careers" className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.2em] bg-white text-sky-600 px-6 py-3 rounded-lg w-fit">
