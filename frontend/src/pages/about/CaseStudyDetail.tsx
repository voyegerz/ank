      ...
      <PageLayout>
        <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-6">
          ...
          <p className="text-slate-500 mb-8 max-w-md text-center">
            The project you are looking for might have been moved or archived.
          </p>
          ...
          >
            <div className="flex-1">
              <Link
                ...
                className="inline-flex items-center gap-2 text-indigo-400 font-bold uppercase tracking-widest text-[10px] mb-8 hover:text-white transition-colors group"
              >
                <ArrowLeft
                  size={14}
              ...
              {items.length > 0 && (
                <div className="mt-20 space-y-12">
                  <h4 className="text-xl font-black text-slate-900 uppercase tracking-tight flex items-center gap-3">
                    <CheckCircle2 className="text-primary" size={24} /> Key
            ...
            <div className="lg:col-span-5">
              <div className="sticky top-32">
                ...
                <div className="mt-12 p-10 bg-slate-900 rounded-[2.5rem] text-white">
                  <p className="text-[10px] font-black tracking-[0.3em] text-indigo-400 uppercase mb-4">
                    Take Action
                  </p>
                  <h4 className="text-2xl font-black uppercase mb-6 leading-tight">
                    Empower your Next Venture
                  </h4>
                  <Link to="/contact">
      ...
      <section className="py-32 bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <h2 className="text-3xl font-black text-slate-900 mb-8 uppercase leading-tight italic">
            "Excellence is not an act, but a habit. We build success stories one
