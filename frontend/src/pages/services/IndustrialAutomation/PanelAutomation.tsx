  ...
  return (
    <PageLayout>
      ...
      <ServiceDetail
        ...
        leftParagraphs={[
          "We provide end-to-end solutions for industrial control panels, from initial electrical drafting and component selection to final assembly and testing. Our panels are designed for maximum reliability, optimal space utilization, and ease of maintenance.",
          "Every panel we build follows strict industrial standards for wiring, labeling, and safety. We specialize in integrating complex automation components—including PLCs, HMIs, VFDs, and safety relays—into a cohesive and robust electrical architecture that ensures long-term performance.",
        ]}
        features={[
      ...
      <PhilosophySection
        ...
        title="Built to Last"
        paragraphs={[
          "The control panel is the heart of any automation system. We believe that a well-designed panel should be as clean and logical as the code that runs inside it, significantly reducing troubleshooting time for plant operators.",
        ]}
        imageSize="xs"
        iconSize={80}
        items={[
