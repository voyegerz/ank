...
const PCBassembly = () => {
  return (
    <PageLayout>
      <CommonHero
        title="PCB Assembly"
        caption="Precision electronic manufacturing for complex industrial applications."
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-6">
                <CapabilityItem
                  title="SMT & Through-Hole"
                  desc="State-of-the-art surface mount and through-hole assembly lines."
                />
                <CapabilityItem
                  title="Multi-Layer Expertise"
                  desc="Experience with high-density, multi-layer rigid and flex PCBs."
                />
                <CapabilityItem
                  title="Quality Testing"
                  desc="Automated Optical Inspection (AOI) and functional testing for 100% reliability."
                />
              </div>
            </div>
            <div className="bg-slate-50 p-12 rounded-[3rem] border border-slate-100">
              ...
              <p className="text-slate-600 font-medium leading-relaxed mb-8">
                We provide rapid prototyping and full-scale production runs with
              ...
              <button className="w-full bg-indigo-600 text-white py-5 rounded-2xl font-black text-lg hover:bg-slate-900 transition-all flex items-center justify-center gap-3">
                Request PCB Quote <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </div>
