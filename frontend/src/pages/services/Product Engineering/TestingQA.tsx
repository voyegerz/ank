...
const TestingQA = () => {
  return (
    <PageLayout>
      <CommonHero
        title="Testing & QA"
        caption="Ensuring every product and software solution meets the highest standards of reliability."
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-6">
                <CapabilityItem
                  ...
                  desc="Comprehensive unit, integration, and end-to-end testing for all software applications."
                />
                <CapabilityItem
                  title="Hardware Validation"
                  desc="Rigorous environmental and stress testing of electronic components and mechanical parts."
                />
                <CapabilityItem
                  title="Functional Verification"
                  desc="Ensuring all system requirements are met through meticulous manual and automated checks."
                />
                <CapabilityItem
                  title="Performance Benchmarking"
                  desc="Analyzing system response times and throughput under peak load conditions."
                />
              </div>
            </div>
            <div className="bg-slate-50 p-12 rounded-[3rem] border border-slate-100">
              ...
              <p className="text-slate-600 font-medium leading-relaxed mb-8">
                Our QA process is integrated into every stage of development,
                identifying potential issues early and ensuring a flawless final
                release.
              </p>
              <ul className="space-y-4 mb-10">
                ...
                <li className="flex items-center gap-3 text-slate-700 font-bold">
                  <CheckCircle2 className="text-indigo-600" size={20} /> User
