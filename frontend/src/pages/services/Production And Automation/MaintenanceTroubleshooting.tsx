        ...
        <div className="container mx-auto px-6 relative z-10 text-white">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black tracking-normal uppercase mb-6">
              Maintenance{" "}
              <span className="text-indigo-500">& Troubleshooting</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl font-medium">
              Ensuring your industrial systems stay operational with expert
              support.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-6">
                <CapabilityItem
                  ...
                  desc="Expert technicians to troubleshoot and fix industrial hardware and controllers."
                />
                <CapabilityItem
                  title="Preventative Maintenance"
                  desc="Scheduled checks and updates to avoid system downtime before it happens."
                />
                <CapabilityItem
                  title="Remote Diagnostics"
                  desc="Fast support for software and automation issues through remote access."
                />
              </div>
            </div>
            <div className="bg-slate-50 p-12 rounded-[3rem] border border-slate-100">
              ...
              <p className="text-slate-600 font-medium leading-relaxed mb-8">
                We provide the technical expertise needed to keep your
              ...
              <button className="w-full bg-indigo-600 text-white py-5 rounded-2xl font-black text-lg hover:bg-slate-900 transition-all flex items-center justify-center gap-3">
                Request Support <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </div>
