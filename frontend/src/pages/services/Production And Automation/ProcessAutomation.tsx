        ...
        <div className="container mx-auto px-6 relative z-10 text-white">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black tracking-normal uppercase mb-6">
              Process <span className="text-indigo-500">Automation</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl font-medium">
              Streamlining industrial and manufacturing processes with smart
              automation.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-6">
                <CapabilityItem
                  ...
                  desc="Sophisticated control logic for automated industrial machinery."
                />
                <CapabilityItem
                  title="Sensor Integration"
                  desc="Live monitoring and feedback loops for precise process control."
                />
                <CapabilityItem
                  title="Robotic Cell Automation"
                  desc="Automating production lines with advanced robotic systems."
                />
              </div>
            </div>
            <div className="bg-slate-50 p-12 rounded-[3rem] border border-slate-100">
              ...
              <p className="text-slate-600 font-medium leading-relaxed mb-8">
                Our process automation solutions ensure higher quality,
                consistency, and speed in production.
              </p>
