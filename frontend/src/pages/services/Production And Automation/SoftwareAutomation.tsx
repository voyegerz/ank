        ...
        <div className="container mx-auto px-6 relative z-10 text-white">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black tracking-normal uppercase mb-6">
              Software <span className="text-indigo-500">Automation</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl font-medium">
              Automating complex software workflows to increase business
              efficiency.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-6">
                <CapabilityItem
                  ...
                  desc="Custom scripts to handle repetitive data entry and processing tasks."
                />
                <CapabilityItem
                  title="System Integration"
                  desc="Connecting disparate software tools to automate cross-platform workflows."
                />
                <CapabilityItem
                  title="RPA Solutions"
                  desc="Robotic Process Automation for large-scale enterprise efficiency."
                />
              </div>
            </div>
            <div className="bg-slate-50 p-12 rounded-[3rem] border border-slate-100">
              ...
              <p className="text-slate-600 font-medium leading-relaxed mb-8">
                We build automation tools that eliminate bottlenecks and free up
