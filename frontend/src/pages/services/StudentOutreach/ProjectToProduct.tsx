  ...
  return (
    <PageLayout>
      ...
      <ServiceDetail
        ...
        leftParagraphs={[
          "Many great engineering projects never leave the lab. Our P2P program provides the necessary bridge to turn a functional prototype into a polished, manufacturable product that meets market standards. We help you refine your design for large-scale production, select cost-effective materials, and implement robust quality control measures.",
          "Productization is more than just manufacturing; it's about branding, packaging, and certification. Through the P2P program, innovators gain access to our network of industrial partners and manufacturing facilities, significantly reducing the capital and expertise required to launch a new hardware product.",
        ]}
        features={[
      ...
      <PhilosophySection
        ...
        paragraphs={[
          "A project becomes a product when it starts solving problems for others. We believe that some of the most impactful engineering innovations start in student dorms and academic labs, and our mission is to empower them.",
        ]}
        imageSize="xs"
        iconSize={80}
        items={[
