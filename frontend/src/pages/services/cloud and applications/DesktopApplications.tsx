        ...
        <div className="container mx-auto px-6 relative z-10 text-white">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black tracking-normal uppercase mb-6">
              Desktop <span className="text-indigo-500">Applications</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl font-medium">
              Powerful desktop software for specialized industrial and business
              use.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-6">
                <CapabilityItem
                  ...
                  desc="Building desktop apps for Windows, macOS, and Linux using modern tech."
                />
                <CapabilityItem
                  title="Local Hardware Integration"
                  desc="Software that interacts directly with local sensors, machines, and controllers."
                />
                <CapabilityItem
                  title="Offline Data Management"
                  desc="Secure, local-first data processing and storage."
                />
              </div>
            </div>
            <div className="bg-slate-50 p-12 rounded-[3rem] border border-slate-100">
              ...
              <p className="text-slate-600 font-medium leading-relaxed mb-8">
                We create desktop tools that handle complex processing and local
              ...
              <button className="w-full bg-indigo-600 text-white py-5 rounded-2xl font-black text-lg hover:bg-slate-900 transition-all flex items-center justify-center gap-3">
                Start Desktop Project <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </div>
