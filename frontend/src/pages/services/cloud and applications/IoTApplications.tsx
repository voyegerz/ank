        ...
        <div className="container mx-auto px-6 relative z-10 text-white">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black tracking-normal uppercase mb-6">
              IoT <span className="text-indigo-500">Applications</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl font-medium">
              Connecting the physical and digital worlds with smart IoT
              platforms.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-6">
                <CapabilityItem
                  ...
                  desc="Dashboards and alerts for live tracking of industrial sensors and devices."
                />
                <CapabilityItem
                  title="Device Management"
                  desc="Centralized platforms to manage, update, and secure your IoT fleet."
                />
                <CapabilityItem
                  title="Data Analytics"
                  desc="Processing massive IoT data streams to unlock actionable business insights."
                />
              </div>
            </div>
            <div className="bg-slate-50 p-12 rounded-[3rem] border border-slate-100">
              ...
              <p className="text-slate-600 font-medium leading-relaxed mb-8">
                We build IoT solutions that enhance visibility and control over
              ...
              <button className="w-full bg-indigo-600 text-white py-5 rounded-2xl font-black text-lg hover:bg-slate-900 transition-all flex items-center justify-center gap-3">
                Connect Your Fleet <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </div>
