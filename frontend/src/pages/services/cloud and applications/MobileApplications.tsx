        ...
        <div className="container mx-auto px-6 relative z-10 text-white">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black tracking-normal uppercase mb-6">
              Mobile <span className="text-indigo-500">Applications</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl font-medium">
              Native-grade mobile experiences for iOS and Android.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-6">
                <CapabilityItem
                  ...
                  desc="Expertise in React Native and Flutter for efficient, unified app development."
                />
                <CapabilityItem
                  title="Offline Capabilities"
                  desc="Apps designed to work seamlessly even without an internet connection."
                />
                <CapabilityItem
                  title="Hardware Integration"
                  desc="Leveraging device-specific features like GPS, Camera, and Biometrics."
                />
              </div>
            </div>
            <div className="bg-slate-50 p-12 rounded-[3rem] border border-slate-100">
              ...
              <p className="text-slate-600 font-medium leading-relaxed mb-8">
                We design and develop mobile apps that prioritize speed,
              ...
              <button className="w-full bg-indigo-600 text-white py-5 rounded-2xl font-black text-lg hover:bg-slate-900 transition-all flex items-center justify-center gap-3">
                Start Mobile Project <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </div>
