        ...
        <div className="container mx-auto px-6 relative z-10 text-white">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black tracking-normal uppercase mb-6">
              Web <span className="text-indigo-500">Applications</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl font-medium">
              Scalable, high-performance web platforms for modern businesses.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-6">
                <CapabilityItem
                  ...
                  desc="React-based, highly responsive, and user-centric interfaces."
                />
                <CapabilityItem
                  title="Robust Backend"
                  desc="Node.js and Python architectures designed for scale and security."
                />
                <CapabilityItem
                  title="API Development"
                  desc="Seamless integration through well-documented and secure RESTful APIs."
                />
              </div>
            </div>
            <div className="bg-slate-50 p-12 rounded-[3rem] border border-slate-100">
              ...
              <p className="text-slate-600 font-medium leading-relaxed mb-8">
                We build web applications that drive engagement and streamline
                business workflows.
              </p>
